...
xaringan_to_pdf <- function(
  ...
  b <- chromote::ChromoteSession$new(auto_events = FALSE)
  on.exit(b$close(), add = TRUE)
  
  b$Page$navigate(input, wait_ = FALSE)
...
xaringan_to_pdf("file:///Users/macadmin/Downloads/short_course_EPBEST/Slides/index.html")
