...
title: "R intermediário<br>"
subtitle: "visualização de dados com o R <br><br><br>"
author: "<br><br><br><br> Bruno Santos <br> Departamento de Estatística/CCE/UFES"
date: "nov/2019"
output:
...
```{r plot-exemplo-ggplot-1-6-3, echo=T, fig.show="hide", collapse=T, comment = "  #>", out.width="90%"}
#exemplo
 ggplot(dados, aes(x = var_x, y = var_y, 
                   color = var_grupo)) +
  geom_point() + 
...
.right-plot[
![](`r knitr::fig_chunk("plot-exemplo-ggplot-1-6-3", "png")`)
]
...
<!-- sintaxe básica do ggplot-1-9-1 -->
---
class: middle
...
```{r plot-exemplo-ggplot-1-9-1, echo=T, fig.show="hide", collapse=T, comment = "  #>", out.width="90%"}
# exemplo
 ggplot(dados, aes(x = var_x, y = var_y, 
                   color = var_grupo,
                   label = var_x)) +
...
.right-plot[
![](`r knitr::fig_chunk("plot-exemplo-ggplot-1-9-1", "png")`)
]
...
.left-code[
```{r plot-exemplo-bar6-1, echo=TRUE, fig.show="hide", out.width="90%"}
ggplot(df, aes(x = Type)) +
  geom_bar(fill = "darkorchid4") +
  labs(x = "Tipo de carro", y = "Contagem",
       title = "Tipo de carro") +
...
.right-plot[
![](`r knitr::fig_chunk("plot-exemplo-bar6-1", "png")`)
]
...
.left-code[
```{r plot-exemplo-bar7.1-1, echo=TRUE, fig.show="hide", out.width="90%"}
ggplot(df, aes(x = Type, fill = AirBags)) +
  geom_bar(position = "dodge", 
               color = "black") +
  theme_minimal() +
...
.right-plot[
![](`r knitr::fig_chunk("plot-exemplo-bar7.1-1", "png")`)
]
...
.left-code[
```{r plot-exemplo-bar7.1-2, echo=TRUE, fig.show="hide", out.width="90%"}
ggplot(df, aes(x = Type, fill = AirBags)) +
  geom_bar(position = "dodge", 
               color = "black") +
  theme_minimal() +
...
.right-plot[
![](`r knitr::fig_chunk("plot-exemplo-bar7.1-2", "png")`)
]
...
.left-code[
```{r plot-exemplo-bpt2-0-0, echo=TRUE, fig.show="hide", out.width="90%"}
...
.right-plot[
![](`r knitr::fig_chunk("plot-exemplo-bpt2-0-0", "png")`)
]
...
.left-code[
```{r plot-exemplo-bpt2-0, echo=TRUE, fig.show="hide", out.width="90%"}
ggplot(dfhair, aes(x = Sex, y = Freq)) +
  theme_minimal() +
  geom_boxplot()
...
.right-plot[
![](`r knitr::fig_chunk("plot-exemplo-bpt2-0", "png")`)
]
...
.left-code[
```{r plot-exemplo-bpt2-v0, echo=TRUE, fig.show="hide", out.width="90%"}
ggplot(dfhair, aes(x = Sex, y = Freq, 
                   fill = Sex)) +
  theme_minimal() +
  geom_boxplot() + 
...
.right-plot[
![](`r knitr::fig_chunk("plot-exemplo-bpt2-v0", "png")`)
]
...
.left-code[
```{r plot-exemplo-disp3-1, echo=TRUE, fig.show="hide", out.width="90%"}
ggplot(mtcars, aes(mpg, drat)) +
...
.right-plot[
![](`r knitr::fig_chunk("plot-exemplo-disp3-1", "png")`)
]
...
.left-code[
```{r plot-exemplo-corr-0, echo=TRUE, fig.show="hide", out.width="90%"}
library(corrplot)
...
.right-plot[
![](`r knitr::fig_chunk("plot-exemplo-corr-0", "png")`)
]
...
- [Livro do Hadley Wickham (R for Data Science)](https://r4ds.had.co.nz/index.html)
